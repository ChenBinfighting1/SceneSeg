...
class NetLoader:
    ...
    def model_init(self, cfg):
        ...
        checkpoint = torch.load(cfg.TEST_CKPT, map_location=device)
        pretrained_dict = {}
...
def show_videos_with_trackbar(video_name, nets_dict, generate_img, flag_showIOU=False):
    ...
    while 1:
        ...
        # img_one = cv2.resize(img_one, (0, 0), fx=0.125, fy=0.125)
...
def main(cfg, nets_dict, flag):
    ...
    imgs_dir = "/home/xjx/data/videos/mask/LB_DY_000045"

    # video_root = "/home/xjx/data/videos/mask/test_video"
    # video_root = "/home/xjx/data/videos/mask/mask_test_video/PT_LB_Video"
    video_root = "/home/lee/sz_dy"
    # video_root = "/home/xjx/data/videos/CatDog_20190115/CatDog_Videos/cat"
...
if __name__ == '__main__':
    ...
    from config.scene_deeplab import Configuration
    ...
    img_dir = "/home/xjx/data/videos/mask/Green_Screen_1/PM_GS_000006"
    ...
    import copy
    cfg_sc256 = Configuration()
    # 以下操作为了可视化时换网络结构进行对比
    cfg_sc256.DATA_RESCALE = 256
    cfg_sc256.INIT_model = edict({
        "type": "SE_Res50UNet",
        "args": {
            'num_classes': 9,
            'num_filters': 32,
    ...
    cfg_sc256_aspp = Configuration()
    cfg_sc256_aspp.DATA_RESCALE = 256
    cfg_sc256_aspp.INIT_model= edict({
            "type": "deeplabv3plus",
            "args": {
                'num_classes': 9,
    ...
    cfg_res50 = Configuration()
    cfg_res50.DATA_RESCALE = 256
    cfg_res50.INIT_model= edict({
            "type": "deeplabv3plus_nodilation",
            "args": {
                'num_classes': 9,
                "MODEL_BACKBONE": 'std_res50_16',
                'MODEL_OUTPUT_STRIDE': 16,
                'MODEL_ASPP_OUTDIM': 128,
                'MODEL_SHORTCUT_DIM': 48,
                'MODEL_SHORTCUT_KERNEL': 1,
    ...
    nets_dict = {
        ...
        #                   num_classes=2, flip=True, multi_scale=1, vis_type='mix_img', edge_width=2),
        'scene': NetLoader(Configuration(), 'deeplabv3plus', 'res50_atrous',
                          ckpt='/home/lee/work/share/scene/models/best_model_scene_deeplab_miou.pth',
                          num_classes=9, flip=False, multi_scale=1, vis_type='mix_img', edge_width=2),
        # '28w scene': NetLoader(Configuration(), 'deeplabv3plus', 'res50_atrous',
        #                   ckpt='/home/lee/work/share/scene/models/scene_deeplab_itr28000.pth',
        #                   num_classes=9, flip=False, multi_scale=1, vis_type='mix_img', edge_width=2),
        # 'sc 256': NetLoader(cfg_sc256, 'deeplabv3plus', 'res50_atrous',
        #                   ckpt='/home/lee/work/share/scene/models/best_model_scene_unet256input_miou.pth',
        #                   num_classes=9, flip=False, multi_scale=1, vis_type='mix_img', edge_width=2),
        '256 aspp 128': NetLoader(cfg_sc256_aspp, 'deeplabv3plus', 'res50_atrous',
                          ckpt='/home/lee/work/share/scene/models/best_model_scene_deeplab_256input_Aspp128_miou.pth',
                          num_classes=9, flip=False, multi_scale=1, vis_type='mix_img', edge_width=2),
        '256 res50 16': NetLoader(cfg_res50, 'deeplabv3plus', 'res50_atrous',
                          ckpt='/home/lee/work/share/scene/models/best_model_scene_deeplab_256input_Aspp128_TS_reconasppRes50_Steacher_lr6_miou.pth',
                          num_classes=9, flip=False, multi_scale=1, vis_type='mix_img', edge_width=2),
        # 'parse ': NetLoader(Configuration(), 'deeplabv3plus', 'res101_atrous',
        #                   ckpt='/home/xjx/data/model/deeplab_LMv2_703_itr96epoch.pth',
        #                   num_classes=2, flip=True, multi_scale=1, vis      _type='mix_img', edge_width=2),
