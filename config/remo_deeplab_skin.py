...
class Configuration():
    ...
    # ----------------- dataset ----------------------
        if flag_debug is True:
            ...
            self.txt_f = '/home/zhangming/SSD_DATA/Skin/compaq_skin_data/compaq_skin_data_train.txt'
            self.root_dir = '/home/zhangming/SSD_DATA/Skin/compaq_skin_data'

            self.val_txt_f = '/home/zhangming/SSD_DATA/Skin/compaq_skin_data/compaq_skin_data_val.txt'
            self.val_root_dir = '/home/zhangming/SSD_DATA/Skin/compaq_skin_data'
    ...
    # ----------------- adjust lr --------------------
        ...
        self.TRAIN_SAVE_CHECKPOINT = 800  # save checkpoint
        self.TRAIN_SHUFFLE = True
        self.display = 10

        self.TRAIN_MINEPOCH = 0
        self.TRAIN_EPOCHS = 96  # epoch
        ...
        self.VAL_CHECKPOINT = 200  # val checkpoint
