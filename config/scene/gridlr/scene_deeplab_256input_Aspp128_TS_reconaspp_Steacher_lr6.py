...
class Configuration():
    ...
    # ----------------- dataset ----------------------
        if flag_debug is True:
            self.txt_f = ['/home/xjx/data/mask/ADE_COCO_scene/coco_train.txt',
                          '/home/xjx/data/mask/ADE_COCO_scene/ade_train.txt']
            self.root_dir = None

            self.val_txt_f = ['/home/xjx/data/mask/ADE_COCO_scene/coco_val.txt',
                              '/home/xjx/data/mask/ADE_COCO_scene/ade_val.txt']
            self.val_root_dir = None
        else:
            self.txt_f = ['/home/zhangming/Datasets/mask/ADE_COCO_scene/coco_train.txt',
                          '/home/zhangming/Datasets/mask/ADE_COCO_scene/ade_train.txt']
            self.root_dir = None

            self.val_txt_f = ['/home/zhangming/Datasets/mask/ADE_COCO_scene/coco_val.txt',
                              '/home/zhangming/Datasets/mask/ADE_COCO_scene/ade_val.txt']
            self.val_root_dir = None

        self.DATA_WORKERS = 8
        self.DATA_RESCALE = int(256)
    ...
    # ----------------- model ------------------------
        ...
        self.LOAD = edict({
            "type":"loadParam",
            "args":{"distill":{
                        "S_head":"teacher",# "teacher", "Nohead"
                        "TeacherModel": "/home/zhangming/work/mask/mmsegment_v1/ckpt/model/scene_deeplab_256input_Aspp128/best_model_scene_deeplab_256input_Aspp128_miou.pth"
                    }
                }
            })
        
        self.MODEL_NUM_CLASSES = 9 # class
        ...
        self.INIT_model = edict({
            ...
            "args": {"T":{
                ...
                "mode":"reconstruction",# "KLDiv","reconstruction&KLDiv"
                "featuremap":"aspp",# "concat"
            }
        })
    ...
    # ----------------- optmi ------------------------
        self.TRAIN_LR = 0.000001   # learning rate
        ...
        self.INIT_params = edict({
            ...
            "args": {
                "lr": self.TRAIN_LR,
                "distill": self.LOAD.args.distill
            }
        })
    ...
    # ----------------- adjust lr --------------------
        ...
        if flag_debug is True:
            ...
            self.GPUS_ID = [2, 3]
            self.batch_size_per_gpu = 22  # 每张卡的bs
