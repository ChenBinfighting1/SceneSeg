...
class Configuration():
    ...
    # ----------------- optmi ------------------------
        self.TRAIN_LR = 0.03   # learning rate
    ...
    # ----------------- adjust lr --------------------
        ...
        if flag_debug is True:
            ...
            self.GPUS_ID = [2, 3]
            self.batch_size_per_gpu = 12  # 每张卡的bs

        self.TRAIN_SAVE_CHECKPOINT = 5000  # save checkpoint
        ...
        self.TRAIN_CKPT = '/home/zhangming/.torch/models/se_resnext50_32x4d-a260b3a4.pth'
        ...
        if flag_debug:
            ...
            self.val_batch_size_per_gpu = 12

        self.VAL_CHECKPOINT = 5000  # val checkpoint
