...
class Configuration():
    ...
    # ----------------- dataset ----------------------
        if flag_debug is True:
            ...
            self.txt_f = '/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256/train2.txt'
            self.root_dir = '/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256'

            self.val_txt_f = '/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256/test2.txt'
    ...
    # ----------------- adjust lr --------------------
        ...
        self.TRAIN_SAVE_CHECKPOINT = 4000  # save checkpoint
        ...
        self.VAL_CHECKPOINT = 1500  # val checkpoint
