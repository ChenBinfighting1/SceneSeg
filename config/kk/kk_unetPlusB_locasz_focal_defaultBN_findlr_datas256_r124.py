...
class Configuration():
    ...
    # ----------------- dataset ----------------------
        if flag_debug is True:
            ...
            self.txt_f = ['/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256/train1.txt',
'/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256/train2.txt','/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256/train4.txt']
            self.root_dir = '/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256'

            self.val_txt_f = ['/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256/test1.txt',
'/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256/test2.txt','/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256/test4.txt']
            self.val_root_dir = '/home/zhangming/Datasets/mask/Kaggle/rematch/data_s256'
    ...
    # ----------------- adjust lr --------------------
        ...
        if flag_debug is True:
            ...
            self.GPUS_ID = [2, 3]
            self.batch_size_per_gpu = 3 # 每张卡的bs

        self.TRAIN_SAVE_CHECKPOINT = 40000  # save checkpoint
        ...
        if flag_debug:
            ...
            self.val_batch_size_per_gpu = 3

        self.VAL_CHECKPOINT = 3000  # val checkpoint
