...
class Configuration():
    ...
    # ----------------- dataset ----------------------
        if flag_debug is True:
            ...
            self.txt_f = '/home/zhangming/SSD_DATA/Skin/CeleAMask/CeleAMask_train.txt'
            self.root_dir = '/home/zhangming/SSD_DATA/Skin/CeleAMask'

            self.val_txt_f = '/home/zhangming/SSD_DATA/Skin/CeleAMask/CeleAMask_val.txt'
            self.val_root_dir = '/home/zhangming/SSD_DATA/Skin/CeleAMask'
