...
class Configuration():
    ...
    # ----------------- dataset ----------------------
        if flag_debug is True:
            ...
            self.txt_f = ['/home/zhangming/SSD_DATA/scene/ADE_COCO_scene/coco_train.txt',
                          '/home/zhangming/SSD_DATA/scene/ADE_COCO_scene/ade_train.txt']
            self.root_dir = None

            self.val_txt_f = ['/home/zhangming/SSD_DATA/scene/ADE_COCO_scene/coco_val.txt',
                              '/home/zhangming/SSD_DATA/scene/ADE_COCO_scene/ade_val.txt']
            self.val_root_dir = None
    ...
    # ----------------- model ------------------------
        ...
        self.INIT_model = edict({
            ...
            "args": {"T":{
                ...
                "mode":"reconstruction&KLDiv",# "KLDiv","reconstruction&KLDiv"
                "featuremap":"concat",# "concat"
            }
        })
    ...
    # ----------------- loss -------------------------
        ...
        self.INIT_loss = edict({
            ...
            "args": {
                ...
                "CE_weights":1.0,
                "KL_weights":1.0,
                "mode":self.INIT_model.args.mode
            }
        })
        
    # ----------------- optmi ------------------------
        self.TRAIN_LR = 0.0000001   # learning rate
    ...
    # ----------------- adjust lr --------------------
        ...
        if flag_debug is True:
            ...
            self.GPUS_ID = [2, 3]
            self.batch_size_per_gpu = 20  # 每张卡的bs
